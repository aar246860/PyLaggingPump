...
def fit(req: FitRequest):
    # TODO: wire to core.fitters.search and core.models.<model>
    # For now, return a stub so the API is runnable end-to-end.
    return {
        "model": req.model,
        ...
        "curves": {"observed": [(d.t,d.s) for d in req.data], "fitted": []}
    }
